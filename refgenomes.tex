...
This enables answering questions like whether variants associated with Schizophrenia tend to be located more in accessible chromatin regions of immune cells than of brain cells~\cite{hyperbrowserexample}. \TODO{find example}
...
The central concept of mapping and aligning reads to a sequence graph is more thoroughly introduced in Sections~\ref{sec:alignment} and \ref{sec:mapping}.
