...
{\textcolor{red}{0} & \textcolor{black!25}{-1} & \textcolor{black!25}{-2} & \textcolor{black!25}{-3} & \textcolor{black!25}{-4} & \textcolor{black!25}{-5} & \textcolor{black!25}{-6}\\
...
\matrix (m2) [matrix of math nodes, align=right, below=of m, row sep=0.1em,column sep=0.1em, minimum width=1em, minimum height=1em, nodes={align=right}]{
A & C & G & T & T & - & A & C\\ 
A & C & - & T & T & G & A & -\\ 
};
\end{tikzpicture}
