...
In the beginning of the 2000s, several technologies were developed that were able to parallelize the process of sequencing and thus increased the throughput. Among these technologies,  collectively called Next-Generation Sequencing (NGS), Illumina\TODO{trademark?} dye sequencing is the most commonly used, and will be described here.
