...
\emph{vg}~\cite{vg} has been at the forefront of mapping to a graph reference in company with \emph{seven bridges}~\cite{7bridges}, showing that it can lead to better mapping accuracy than BWA-mem.
