...
Breakpoints $B = \set{i : \exists s s.t. (i, s) \in I} \cup \set{i : \exists l s.t. (i, l) \in D \vee (i-l, l) \in D}$.
Let $(b_1, b_2, ..., b_{n_r})$ be the ordered elements of $B \cup \set{0, \size{G}}$. We then get a reference graph as
\begin{align*}
  G_r &= (V_r, E_r)\\
  V_r &= \set{1, 2,,, n_r}\\
